...
public class WordSerivceImplV2 extends WordServiceImplV1A {
	...
	public void viewWord2() {
		...
		String[] strWords = strEng.split(""); // => 영어 단위가 알파펫으로 나뉜뒤 배열에 담김
		...
		while(true ) {
			...
			System.out.println("-".repeat(50));
			System.out.println("다음 단어를 올바르게 배열하시오(QUit: 입력중단)");
