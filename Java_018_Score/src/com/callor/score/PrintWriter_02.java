...
public class PrintWriter_02 {
	 ...
	 * 
	 * 이 데이터를 파일에 저장, 읽기를 할때 또는 네트워크를 통해서
	 * 	데이터를 교환할때는 모든 데이터를 BIT 단위로만 취급할수 있다
	 * 	
	...
	public static void main(String[] args) {
		...
		try {
			...
			while(true) {
				System.out.print(">> ");
				String str = buffer.readLine(); // => scan.nextLine();과 같은 일을 함
