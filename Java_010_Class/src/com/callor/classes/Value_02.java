...
/*
 * null 값
 * 프로그래밍, 정보처리에서는 어떤 항목의 데이터가 있는가
 * 없는가를 판단해야하는 경우가 있다
 * 
 * 문자열의 경우는 값이 없는 경우를 "" 으로 표현할수 있다
 * 숫자형일 경우 일반적으로 0이라는 값을 없는 값으로
 * 		표현을 하기도 한다
 * 
 * if( 변수 == 0) : 없다 라는 표현을 사용할수 있다
 * 실제로 어떤값이 0인 값을 갖는지, 아니면 아무것도 없어서
 * 	0인지 구별을 못한다
 * null 값을 사용하여 실제로 아무것도 없는 상태를 표현한다
 * 
 * java primitive type의 변수들은 null 값을 저장할 수 없다
 * wrapper class 를 사용하여 선언된 변수는 null을 저장할수 있다
 * 
 * 
 */
...
public class Value_02 {
	...
	public static void main(String[] args) {
		...
		// 그냥 Enter만 눌려도 입력을 종료하고 다음코드가 실행된다
		System.out.print("숫자1>> ");
		String str1 = scan.nextLine();
		
		// " " 문자열 변수의 null 값과 유사한 성격을 갖는 값임
		if(str1 == "") { 
