 ...
 * 
 * 이러한 코드를 작성할때 각각의 method이름을 고유하게 작성하여야 했는데 
 * 	(구조적, 모둘화 프로그래밍 시절에)
 * 
 * 객체지향 프로그래밍 시절에는 매개변수의 타입을
 * 달리하여 같은 프로그램의 이름을 사용할수 있다
 */
public class NumberServiceV1 {
	
	/*
	 * 객체 지향 프로그래밍에서는 한 클래스내에서
	 * 	같은 이름의 method를 중복 선언하여 작성할 수 있다
	 * 단, 매개변수의 개수를 달리하거나 매개변수의 type을 달리하거나 하는
	 * 	방식으로 method를 선언해야 한다
	 */
