 ...
 * 
 * 사용자에게 배포(Deploy) : Release Version 또는 Deploy Version
 * 		실제 사용하는 사람들에게 설치해서 써라
 * 		최초 배포: V1.00 이라고 버전정보를 명시, R1.00이라고 이름을 붙이는 경우도 있음
...
public class PrimeServiceV1 {
	...
	// 여러(2개이상)dml method에서 공통으로 사용할 변수들은
	...
	// method는 첫글자를 소문자로 시작하며
	// 변수 이름짓기와 같은 방식으로 이름을 짓는다 => (Lower)camle case라고 함
	...
	public void printPrime() {
		...
		for(int arr = 0 ; arr < intNums.length ; arr++) {
			...
			} else {System.out.println(numP + "는 소수임"); }
