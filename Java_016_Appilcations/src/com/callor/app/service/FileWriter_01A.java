...
public class FileWriter_01A {
	...
	public static void main(String[] args) {
		 ...
		 * 	Copy Qualified Name를 사용하여 임의 파일 이름을 가져오고
		 * 	필요한 파일로 이름을 변경하여 사용한다 
		 */
		String fileName = "src/com/callor/app/dateA.txt";
		...
		if(num1 < num2) {
			// num1과 num2에 들어있는 난수를 서로 바꾸는 코드
			int temp = num1;
			num1 = num2;
			num2 = temp;
		}
		...
		// FileWriter, PrintWriter를 객체로 선언함
