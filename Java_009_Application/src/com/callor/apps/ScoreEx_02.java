...
public class ScoreEx_02 {
	...
	public static void main(String[] args) {
		...
		// 객체.멤버변수 : 점(DOT . ) 연결연산자 또는 객체 연결연산자라고 부름
		...
		// 객체.method() 객체 연결연산자를 통해서 
		// getTotal() method를 호출(실행)하고 return된 결과를
		// total변수에 담아라
		...
		// 객체 연결연산자를 통하여 멤버 변수나 method에 접근을 하면
		// 오타등으로 발생하는 오류를 최소화 할 수 있다
