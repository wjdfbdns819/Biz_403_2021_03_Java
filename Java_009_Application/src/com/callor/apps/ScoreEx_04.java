...
public class ScoreEx_04 {
	...
	public static void main(String[] args) {
		...
		// 객체 이름짓기
		// 클래스 이름의 첫글자를 소문자로하여 그대로 사용
		ScoreVO scoreVO = new ScoreVO();
		ScoreSevriceV5 scoreSevriceV5 = new ScoreSevriceV5(6);
		...
		System.out.println(n1 + n2); // 문자열을 정수형으로 
		
		Float fn1 = Float.valueOf(str1);
		Float fn2 = Float.valueOf(str2);
		System.out.println(fn1 + fn2); // 실수형으로
		...
		// method를 호출하여 return한 결과를 또다른 method에 매개변수로 전달하는 코드의 예
		System.out.println(
				Arrays.toString(
					"Repblic of Korea".split(" ")
				)
		);
