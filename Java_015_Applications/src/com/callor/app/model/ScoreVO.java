...
public class ScoreVO extends Object {
	/*
	 * 다른 클래스를 extends 하지 않는 이상
	 * 	자동적으로 extends Object를 상속받게 되어있다.
	 */
	 ...
	 * 	Object 클래스에는 시스템적, 메모리적인 method들이 있다
	 * 	이러한 method들은 특별한 용도로 사용한다
	 * 
	 * 	하지만, Object 클래스에 정의되어 있는 method는 
	 * 	일반적인 개발을 할때는 별로 사용을하지 않는다
	 * 
	 * 보통 클래스를 만들때 Object로 부터 상속받은 
	 * 	여러 method들 중에 toString() method를 재 정의 하여
	 * 	디버깅 용도 등으로 활용을 한다
	 */
	...
	// 재 정의
	//	상속받은 클래스에 있는 method를 내맘대로 다시 만들어 쓰기
