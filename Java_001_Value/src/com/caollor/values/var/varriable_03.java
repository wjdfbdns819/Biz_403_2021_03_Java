package com.caollor.values.var;
...
public class varriable_03 {
	public static void main(String[] args) {
		...
		// num1변수와 num2변수에 어떤 값이 저장되어 있는지 관심없다.
		...
		num1 = 30 * 40;
		num2 = 100;
		// 이미 저장된 모든 값을 제거하고 num2 변수에 저장된 값을 
		// 복사하여 저장하라
		num1 = num2;
		 ...
		 * 
		 * 변수는 선언할때 반드시 어떤값을 저장해 주는 것이 좋다
		 * 
		 * 만약 저장될 값이 아직 정해지지 않았다면 0을 저장하자
		 */
