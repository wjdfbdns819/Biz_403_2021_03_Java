...
public static void main(String[] args) {
	 ...
	 * 8. println()에게 덧셈결과가 보관된 기억장소 위치(장소)를 알려준다
	 * 9. println() 덧셈결과가 보관된 기억장소를 찾아가서 보관 값을 가져와서
	 * 		System.out 한테 보낸다
	 * 10. System.out. 은 운영체제(윈도우)에게 결과를 Console(cmd 창)에 
	 * 		출력해달라고 요청
	...
	/*
	 * 위 5가지의 명령코드에서 숫자 30과 40, 그리고 연산 결과는
	 * 기억장치 어딘가에 (임시로)보관이 되어 연산 수행이 이루어진다
	 * 
	 * 그런데, 똑같은 30이라는 숫자가 5번 사용되었지만 
	 * 이 30은 5개의 기억장소를 사용한다
	 * 또한 5번의 40도 5개의 기억장소를 사용하고, 결과를 저장하는 기억장소도
	 * 5개 사용한다
	 * 
	 * 불과 5번의 명령 수행을 위하여 기억장치를 15개 낭비하게 된다
	 * 
	 * 30과 40이라는 두 숫자를 어떤 지정된 기억장소에 보관해 두고 
	 * 연산할때 그 값을 참조하여 연산을 하도록 한다면 기억장치를 
	 * 효육적으로 사용할 수 있을 것이다
	 * 
